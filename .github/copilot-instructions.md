...
> **IMPORTANTE**: 
> 1. Todos los archivos `.feature` DEBEN crearse en la ruta `src/test/java/com/pichincha/features/test-automatisation-base-ltgomez/`.
> 2. Todos los archivos de datos JSON DEBEN ubicarse en `src/test/resources/data/test-automatisation-base-ltgomez/`.
