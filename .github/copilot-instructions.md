...
3. **Formato de escenarios**:
   ...
   **Nota sobre el orden de los pasos en todos los escenarios**:
   - Asegurarse el orden correcto de los pasos, orden correcto de los pasos:
      And path ... debe ir antes de And request ... y When method ....
