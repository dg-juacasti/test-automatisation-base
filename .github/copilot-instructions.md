...
> **IMPORTANTE**:
> 1. Todos los archivos `.feature` DEBEN crearse en la ruta `src/test/resources/features/[nombre_microservicio]/`.
...
| Carpeta de features | nombre del proyecto o servicio  | src/test/resources/features/tre_msa_savings_account                                                 |
...
- Agrupa features por proyecto en `src/test/resourse/features`.
...
Feature: BTPMCDP-118 Crear cuenta exitosamente (microservicio transversal para crear cuentas)
  ...
  Scenario: T-API-BTPMCDP-118-CA01-Crear cuenta exitosamente 201 - karate
    ...
    * def result = call read('classpath:resourse/features/utility/generar_compliance_id.feature@generar_compliance_id')
...
- **Ubicación obligatoria**: `src/test/resources/features/[nombre_microservicio]/`
- **Ejemplo**: `src/test/resources/features/tre_msa_savings_account/crearCuentaAhorros.feature`
...
4. **Verificación de features**:
    - Confirmar que existe la estructura para features en `src/test/resources/features/`
    - Crear las carpetas necesarias para los microservicios que se van a utilizar
